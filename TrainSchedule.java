	...
	public static void main(String[] args){
		...
		for(int i=0;i<trainList.size();i++){
	        ...
	        for( int j=0;j<currentTrain.stationList.size();j++){
				...
				if(currentStation.stationCode.equalsIgnoreCase(cde)&& (currentStation.isStop == true)){
					System.out.println("The Train will stop here......");
					currentTrain.print();
					currentStation.print();
			}
			
			else if(currentStation.stationCode.equalsIgnoreCase(cde)&&(currentStation.isStop == false)){
				System.out.println("The train will not stop at this station......");
				currentTrain.print();
				currentStation.print();
